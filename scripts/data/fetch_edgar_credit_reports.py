...
KEY=re.compile(r'(credit quality|aging|past due|allowance for credit loss|financing receivable)',re.I)
manifest={}
for form,fdate,pend,acc in rows:
    ...
    time.sleep(0.15)
json.dump(manifest,open(os.path.join(SC,'manifest.json'),'w'),indent=1)
